import "./chunk-CLBL2H4I.js";
import {
  capitalize,
  defineComponent,
  h,
  markRaw
} from "./chunk-EK6HECVB.js";
import {
  require_ace
} from "./chunk-AEXVPJ6U.js";
import {
  __toESM
} from "./chunk-ACCAMVX6.js";

// node_modules/vue3-ace-editor/index.js
...
var VAceEditor = defineComponent({
  props: {
    value: {
      type: String,
      required: true
  ...
  mounted() {
    const editor = this._editor = markRaw(import_ace_builds.default.edit(this.$el, {
    ...
    this._ro = new ResizeObserver_es_default(() => editor.resize());
...
//# sourceMappingURL=vue3-ace-editor.js.map
