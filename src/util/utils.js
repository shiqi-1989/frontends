...
import {charAt} from 'vuedraggable/dist/vuedraggable.common'
...
//json格式化
export function JsonFormat(val) {
    try {
        // console.log(val.text)
        // const str = val.text.trim().replace(/'/g, '"').replace(/None/g, 'null').replace(/True/g, 'true').replace(/False/g, 'false');
...
//Html格式话
export var HTMLFormat = (function () {
