<template>
    <el-row style="height: 100%;padding-top: 20px;margin: 0;">
        ...
        <el-col :span="leftSpan">
            <el-card
                ...
                <div style="display: flex;">
                    <el-select v-model="device" clearable placeholder="选择设备"
                               style="flex: 1;">
                        <el-option
                    ...
                    <el-button @click="getDevices">刷新</el-button>
                </div>
                    ...
                    <ul>
                        <li v-for="(item, index) in historyData" :key="index" :class="{active:item.id === currentId}"
                            ...
                            <span style="flex: 1;"
                                ...
                                <span :style="{color: $methodColor(item.method),fontWeight: 'bold',marginRight: '10px'}">
                                    {{ item.method }}
                                </span>
                    ...
                    >
                        ...
                        <div class="path-div">
                            ...
                            <el-dropdown size="large" split-button type="primary"
                                ...
                                <template #dropdown>
                                    <el-dropdown-menu>
                                        <el-dropdown-item @click="openSelPro(item, index)">保存到项目</el-dropdown-item>
                                    </el-dropdown-menu>
                                </template>
                            </el-dropdown>
                        ...
                        <div :class="box_layout? 'body-box':'body-box-row'">
                            <el-tabs id="tabs2" :class="[state?'body-off':'body-on']"
                                ...
                                <el-tab-pane label="Headers" name="Headers">
                                    ...
                                    >
                                        <el-table-column label="参数名"
                                                         min-width="30%">
                                            <template #default="scope">
                                                <el-select v-model="scope.row.name" allow-create clearable filterable
                                ...
                                <el-tab-pane label="Cookies">敬请期待</el-tab-pane>
    ...
    formEl.validate((valid) => {
        if (valid) {
            apis.editApi(table.formData.id, table.formData)
                    .then(({data}) => {
                        editableTabs.value.splice(table.showIndex, 1)
                        try {
