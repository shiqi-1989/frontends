                ...
                <div class="button-box">
                    ...
                    <el-tooltip content="用例详情" placement="top">
                        <el-button circle icon="Operation" size="small" type="primary"
                                   @click="editEvent(scope.row.id, scope.row.title)">
                        </el-button>
                    </el-tooltip>
    ...
    >
        ...
        <el-tabs class="content">
            <el-tab-pane label="用例步骤">
                <CaseDebug :case-id="caseInfo.id" :project-id="projectId"/>
            </el-tab-pane>
            <el-tab-pane label="用例报告">
                <div class="report-list-action">
                    ...
                    <el-button link type="primary" @click="reportList(caseInfo.id)">刷新</el-button>
                </div>
                <el-table
                        ref="reportTableRef"
                        :data="reportData"
