                            ...
                            <div :class="box_layout? 'body-box':'body-box-row'">
                                <el-tabs id="tabs2" :class="[state?'body-off':'body-on']"
                                    ...
                                    <el-tab-pane label="Headers" name="Headers">
                                        <Params :param-data="item.headersData"
                                    ...
                                    <el-tab-pane label="Body">
                                        ...
                                        >
                                            ...
                                            <el-tab-pane label="form-data" name="form-data">
                                                <FormData :form-data="item.formData" :current-id="item.id"/>
                                            </el-tab-pane>
                                            ...
                                            <el-tab-pane name="raw">
                                                ...
                                                <div style="height: 100%;position: relative">
                                                    ...
                                                    <VaceE :raw-data="item.rawData"
                                                           :read-only="false"></VaceE>
                                                </div>
                                            ...
                                            <el-tabs model-value="first" id="requestDiv" type="border-card">
                                                <el-tab-pane label="Response" name="first">
                                                    <div class="response-div">
                                                        <VaceE v-if="item.response?.status"
...
import VaceE from "../../components/VaceE.vue";
...
const toStr = (obj) => {
    if (typeof obj === 'object') {
        return {
            text: JSON.stringify(obj, null, aceConfig.options.tabSize),
            type: 'json5'
        }
    } else if (typeof obj !== 'undefined') {
        try {
            return {
                text: JSON.stringify(JSON.parse(obj), null, aceConfig.options.tabSize),
                type: 'json5'
            }
        } catch (e) {
            try {
